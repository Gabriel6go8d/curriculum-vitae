            ...
            <div className='col-12'>
                <div className='row justify-content-start'>
                    <div className='col-11 m-0 p-0'>
                        <img src={require('../Images/gabriel.jpg')} alt='Gabriel' style={{width: '100%'}} className='p-0 m-0'></img>
                    </div>
                </div> 
                ...
                <Navigation2Piece icon={<FaPhone size='25px' color='black'/>} label='Contacto' section='section-6' id='6'/>            
            </div>     
        </div>       
    )
}
